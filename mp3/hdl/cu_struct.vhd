...
ARCHITECTURE struct OF CU IS
   ...
   SIGNAL predmstall        : std_logic;
   SIGNAL preimstall        : std_logic;
   ...
   SIGNAL im_writel_l_internal : std_logic;
   SIGNAL im_writeh_l_internal : std_logic;
   SIGNAL dm_writeh_l_internal : STD_LOGIC;
   SIGNAL dm_writel_l_internal : STD_LOGIC;
   SIGNAL stall_internal       : std_logic;
   SIGNAL kill_internal        : std_logic;
   SIGNAL dm_read_l_internal   : STD_LOGIC;
...
BEGIN
   ...
   baller : Staller
      PORT MAP (
         ...
         RESET_L     => RESET_L,
         dMiss       => dMiss,
         dm_read_l   => dm_read_l_internal,
         dm_writeh_l => dm_writeh_l_internal,
         dm_writel_l => dm_writel_l_internal,
         stall       => predmstall
      );
   baller1 : Staller
      PORT MAP (
         ...
         RESET_L     => RESET_L,
         dMiss       => iMiss,
         dm_read_l   => im_read_l_internal,
         dm_writeh_l => im_writeh_l_internal,
         dm_writel_l => im_writel_l_internal,
         stall       => preimstall
      );
   Stripperer : Stripper
      PORT MAP (
   ...
   imwriter : writeHigh
      PORT MAP (
         im_writeh_l => im_writeh_l_internal,
         im_writel_l => im_writel_l_internal
      );
   readlsel : MUX2_1
      PORT MAP (
         A   => predm_read_l,
