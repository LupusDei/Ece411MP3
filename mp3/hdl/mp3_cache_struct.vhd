...
ARCHITECTURE struct OF MP3_Cache IS
   ...
   FOR ALL : L2CacheUnit USE ENTITY ece411.L2CacheUnit;
...
BEGIN
   ...
   mrArb : Arbiter
      PORT MAP (
         clk        => clk,
         dpmaddress => dpmaddress,
         dpmdataout => dpmdataout,
         dpmread_l  => dpmread_l,
         dpmwrite_l => dpmwrite_l,
         ipmaddress => ipmaddress,
         ipmdataout => ipmdataout,
         ipmread_l  => ipmread_l,
