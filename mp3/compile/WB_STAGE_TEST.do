...
add wave -hex /wbstage/ALUOut
add wave -hex /wbstage/RegDataIn
add wave /wbstage/RegWrite
add wave /wbstage/DR

echo "First test, ADD R6,R3,R2 should set RegDataIn to ALUOut and DR to 110 and RegWrite to 1"
run 10
...
#/*dr is 110, regwrite is 1, and select aluout for wbmux is 1*/
force /wbstage/wb_c_in 0000000000011011 -freeze 
force /wbstage/aluout 0000000000101010 -freeze
run 20
force /wbstage/wb_c_in 0000000000000000 -freeze 
force /wbstage/aluout 0000000000000000 -freeze
