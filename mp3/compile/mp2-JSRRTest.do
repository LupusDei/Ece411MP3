echo "--- Executing initialization force file for ../testcode/mp2-JSRRTest.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2-JSRRTest.asm program code."
run 5
...
change /mp2_cpu/dram/vhdl_memory/mem(10) X"27"
...
run 5
echo "Done loading ../testcode/mp2-JSRRTest.asm program code."
