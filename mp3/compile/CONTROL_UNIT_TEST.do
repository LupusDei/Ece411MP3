...
add wave -hex /mp3_cpu/controlunit/storeSel
...
virtual signal {/mp3_cpu/controlunit/storeSel == 1 && /mp3_cpu/pcinstaddr == 186} Forward_test6b

add wave -color white Forward_test6a
add wave -color white Forward_test6b
...
virtual signal {/mp3_cpu/controlunit/storeSel == 2 && /mp3_cpu/pcinstaddr == 192} Forward_test7b

add wave -color white Forward_test7a
add wave -color white Forward_test7b
...
#/*pc = 190*/
run 50
force /mp3_cpu/pcinstaddr 0000000010111110 -freeze
force /mp3_cpu/instOut	0110011100001100 -freeze
force /mp3_cpu/id_c_out 0000000100000000 -freeze

#/*str r1, r7, 0*/
run 50
force /mp3_cpu/pcinstaddr 0000000011000000 -freeze
force /mp3_cpu/instOut  0111001111000000 -freeze
force /mp3_cpu/id_c_out 0000001111010000 -freeze

run 50
force /mp3_cpu/pcinstaddr 0000000011000010 -freeze
