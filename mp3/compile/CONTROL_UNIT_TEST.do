...
virtual signal {/mp3_cpu/id_c_in == 0 && /mp3_cpu/ex_c_in == 61440 && /mp3_cpu/pcinstaddr == 8} EX_test2a
virtual signal {/mp3_cpu/id_c_in == 61440 && /mp3_cpu/ex_c_in == 1 && /mp3_cpu/pcinstaddr == 8} EX_test2b
...
virtual signal {/mp3_cpu/id_c_in == 0 && /mp3_cpu/wb_c_in == 61440 && /mp3_cpu/pcinstaddr == 16} WB_test1a
virtual signal {/mp3_cpu/id_c_in == 61440 && /mp3_cpu/ex_c_in == 0 && /mp3_cpu/wb_c_in == 61440 && /mp3_cpu/pcinstaddr == 16} WB_test1b
#/*wb_c_in should be 00...011011   or dr = r6, regwrite = 1, muxSel = 1*/
virtual signal {/mp3_cpu/id_c_in == 61440 && /mp3_cpu/wb_c_in == 27 && /mp3_cpu/pcinstaddr == 16} WB_test1c
