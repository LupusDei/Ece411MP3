echo "--- Executing initialization force file for ../testcode/mp2.2_cp2.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2.2_cp2.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/mp2.2_cp2.asm program code."
