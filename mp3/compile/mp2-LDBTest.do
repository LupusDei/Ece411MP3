echo "--- Executing initialization force file for ../testcode/mp2-LDBTest.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2-LDBTest.asm program code."
run 5
change /mp2_cpu/dram/vhdl_memory/mem(0) X"06"
change /mp2_cpu/dram/vhdl_memory/mem(1) X"24"
change /mp2_cpu/dram/vhdl_memory/mem(2) X"07"
...
run 5
echo "Done loading ../testcode/mp2-LDBTest.asm program code."
