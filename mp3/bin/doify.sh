...
DEFAULT_MEMPATHS="/mp3_cpu/mymp3_cache/IPRAM/vhdl_memory,/mp3_cpu/mymp3_cache/DPRAM/vhdl_memory"
DEFAULT_COMPILEPATH="$HOME/Desktop/mp3_gitfolder/Ece411MP3/mp3/compile"
NAME=${1%\.*}			
